...
| 21 | 2026-06-06 | Login: senha inicial fraca (a pedido) chegou a ser documentada em repo PÚBLICO (removida do estado atual; **permanece no histórico git**). Rodrigo optou por **MANTER** (decisão consciente — uso pessoal, sem dados de terceiros; risco de acesso às cotas/CV aceito). Rotacionável a qualquer momento via `pnpm seed:user`; nunca re-documentar senha em arquivo versionado. | 🟡 | ~10min | Risco aceito (Rodrigo, 2026-06-06) |
