...
| 21 | 2026-06-06 | Login: a senha inicial foi definida fraca (a pedido) e **chegou a ser documentada aqui em repo PÚBLICO → considerar COMPROMETIDA**. Rotacionar por uma forte via `pnpm seed:user` (SEED_PASSWORD via env) e **nunca** escrever senha em arquivo versionado. | 🔴 | ~10min | Pendente (rotacionar) |
